 ...
 */
@Deprecated
public class iProgressDialog extends AlertDialog {
   ...
   private ProgressBar mProgress;
     ...
     */
    public static iProgressDialog show(Context context, CharSequence title,
    ...
    public static iProgressDialog show(Context context, CharSequence title,
        ...
        iProgressDialog dialog = new iProgressDialog(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        *///if (mProgressStyle == STYLE_HORIZONTAL) {
        ...
        View view = inflater.inflate(R.layout.layout_iprogress_dialog, null);
