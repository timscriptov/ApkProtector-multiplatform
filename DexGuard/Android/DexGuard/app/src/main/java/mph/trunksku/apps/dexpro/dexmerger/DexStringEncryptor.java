...
public class DexStringEncryptor {
   ...
   String BYDecoder_ClassType;
    ...
    public DexStringEncryptor(byte[] in,List<String> onlyEncryptClasses) throws Exception {
        ...
        for(String key: StringPoolMap.keySet()){
           ...
           String input="const-string v0, \""+enStr+"\"\n" +
            ...
            //String input="const-string v0, \""+enStr+"\"\n" +
				//"    sput-object v0, Landroid/support/coreutils/AppUtils;->a:Ljava/lang/String;";
        ...
        Smali.assembleSmaliFile(inet("encryptString/BYDecoder.smali").replace(BYDecoder_ClassType_src,BYDecoder_ClassType).replace(BYDecoder_DecodeMethod_src,BYDecoder_DecodeMethod), dexBuilder, new SmaliOptions());


		
        String MethodPoolSmali=inet("encryptString/MethodPool.smali");
    ...
    private String dealSmali(String smali, String type) throws Exception {
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (m.find()) {
                ...
                String methodName= getRandomLitter(3)+getRandomStr(5)+ getRandomLitter(3);
                String pass= BES.MD5.encode16(type);
                String fieldName= getRandomLitter(3)+getRandomStr(5)+ getRandomLitter(3);
    ...
    private String createMethod(String methodName,String pass,String fieldName){
        String smali= inet("encryptString/method.smali");
