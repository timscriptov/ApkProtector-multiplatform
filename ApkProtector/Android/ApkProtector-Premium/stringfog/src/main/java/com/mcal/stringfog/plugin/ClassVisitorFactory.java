...
public final class ClassVisitorFactory {
    ...
    public static @NotNull ClassVisitor create(IStringFog stringFogImpl, StringFogMappingPrinter mappingPrinter,
    ...
    private static @NotNull ClassVisitor createEmpty(ClassWriter cw) {
