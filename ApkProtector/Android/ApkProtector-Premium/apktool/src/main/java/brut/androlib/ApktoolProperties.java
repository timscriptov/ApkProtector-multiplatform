...
public class ApktoolProperties {
    ...
    private static void loadProps() {
        ...
        try {
            InputStream in = AndroidApktool.open("properties/apktool.properties");
            sProps.load(in);
            in.close();
        } catch (Throwable ex) {
        ...
        try {
            templateStream = AndroidApktool.open("properties/baksmali.properties");
        } catch(Throwable ex) {
        ...
        templateStream = null;
        try {
            templateStream = AndroidApktool.open("properties/smali.properties");
        } catch(Throwable ex) {
