...
public class Xor {
    public static void exfr(@NonNull String protectKey, @NonNull InputStream inputStream, OutputStream outputStream) throws IOException {
    ...
    @NonNull
    @Contract(pure = true)
    private static int[] FxIjsF(@NonNull int[] iArr) {
