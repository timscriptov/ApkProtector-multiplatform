...
public class CertCreator {
    ...
    public static void createKeystoreAndKey(String storePath, char[] password,
                                            String keyName, kellinwood.security.zipsigner.optional.DistinguishedNameValues distinguishedNameValues) {
    ...
    public static KeySet createKeystoreAndKey(String storePath, char[] storePass,
                                              ...
                                              String certSignatureAlgorithm, int certValidityYears, kellinwood.security.zipsigner.optional.DistinguishedNameValues distinguishedNameValues) {
        try {
            ...
            KeyStore privateKS = kellinwood.security.zipsigner.optional.KeyStoreFileManager.createKeyStore(storePath, storePass);
            ...
            kellinwood.security.zipsigner.optional.KeyStoreFileManager.writeKeyStore(privateKS, storePath, storePass);
    ...
    public static KeySet createKey(String storePath, char[] storePass,
                                   ...
                                   kellinwood.security.zipsigner.optional.DistinguishedNameValues distinguishedNameValues) {
        try {

            KeySet keySet = createKey(keyAlgorithm, keySize, keyName, certSignatureAlgorithm, certValidityYears,
                    distinguishedNameValues);

            KeyStore privateKS = kellinwood.security.zipsigner.optional.KeyStoreFileManager.loadKeyStore(storePath, storePass);
    ...
    public static KeySet createKey(String keyAlgorithm, int keySize, String keyName,
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                PKCertificate = v3CertGen.generate(KPair.getPrivate());   //fix in Android P NoSuchAlgorithmException
            } else {
                PKCertificate = v3CertGen.generate(KPair.getPrivate(), "BC");
