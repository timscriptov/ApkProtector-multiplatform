 ...
 */
        ...
        public:
            ...
            FromFd(borrowed_fd fd, off64_t offset, size_t length,
                   int prot);
             ...
             */
            static std::unique_ptr <MappedFile>
            FromOsHandle(os_handle h, off64_t offset, size_t length,
                         int prot);
        ...
        private:
            ...
            MappedFile(char *base, size_t size, size_t offset) : base_(base), size_(size),
                                                                 offset_(offset) {}
