...
// Class expected
        ...
        public:
            ...
            constexpr explicit expected(U &&v) : var_(std::in_place_index < 0 > ,
                                                      T(std::forward<U>(v))) {}
            ...
            template<class U = T _ENABLE_IF(
                    ...
                    !std::is_same_v < expected<T, E>,
                    std::remove_cv_t < std::remove_reference_t < U>>> &&
                            !std::conjunction_v<std::is_scalar<T>, std::is_same < T,
                    std::decay_t < U>>> &&
...
// Comparison with unexpected<E>
        ...
        public:
            ...
            // Note for SFNAIE above applies to here as well
            expected &
            operator=(expected &&rhs) noexcept(std::is_nothrow_move_assignable_v < E > ) = default;
            ...
            operator==(const expected<void, E1> &x, const expected<void, E2> &y);
        ...
        public:
            ...
            constexpr unexpected(unexpected &&) noexcept(std::is_nothrow_move_constructible_v <
                                                         E > ) = default;
            ...
            operator=(unexpected &&) noexcept(std::is_nothrow_move_assignable_v < E > ) =
            default;
