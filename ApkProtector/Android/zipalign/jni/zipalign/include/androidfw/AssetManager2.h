...
// AssetManager2 provides caching of resources retrieved via the underlying ApkAssets.
    ...
    public:
        ...
        // idmap.
        bool SetApkAssets(const std::vector<const ApkAssets *> &apk_assets,
        ...
        uint32_t
        GetResourceId(const std::string &resource_name, const std::string &fallback_type = {},
    ...
    private:
        ...
        ApkAssetsCookie
        FindEntry(uint32_t resid, uint16_t density_override, bool stop_at_first_match,
    ...
    public:
        ...
        // function.
        ApkAssetsCookie
        GetAttribute(uint32_t resid, Res_value *out_value, uint32_t *out_flags) const;
