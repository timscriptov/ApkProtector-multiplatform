 ...
 */
    ...
    private:
        ...
        public:
            ...
            Entry(TKey _key, TValue _value) : key(_key), value(_value), parent(nullptr),
                                              child(nullptr) {
            }
...
// Implementation is here, because it's fully templated
    ...
    LruCache<TKey, TValue>::LruCache(uint32_t maxCapacity)
            : mSet(new LruCacheSet()), mListener(nullptr), mOldest(nullptr), mYoungest(nullptr),
              mMaxCapacity(maxCapacity), mNullValue(0) {
