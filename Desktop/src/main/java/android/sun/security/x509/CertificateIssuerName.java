...
public class CertificateIssuerName implements CertAttrSet<String> {
     ...
     */
    public CertificateIssuerName(android.sun.security.x509.X500Name name) {
        this.dnName = name;
    }
     ...
     */
    public CertificateIssuerName(android.sun.security.util.DerInputStream in) throws IOException {
