...
public class BaffleTask extends Task {
	...
	private static final String helper = "[--config(true/false) filepaths list] [--output(true/false) filepath] ApkFile TargetApkFile";
	...
	public void execute() throws BuildException {
		...
		} catch (IOException | BaffleException e) {
