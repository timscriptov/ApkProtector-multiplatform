...
public class MyClassLoader {
    ...
    public MyClassLoader(@NotNull Context context, List<File> dexFiles, File dexDir, File optDir) {
        mContext = context;
        mDexFiles = dexFiles;
        mDexDir = dexDir;
        mOptDir = optDir;
    ...
    private static void expandFieldArray(Object instance, Object @NotNull [] extraElements) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    public void loadDexByVersion() throws Exception {
        //try {
            //Class<?> classLoaderClz = Class.forName("java.lang.ClassLoader");
            //Method getClassLoader = classLoaderClz.getDeclaredMethod("getClassLoader");
            //getClassLoader.setAccessible(true);
            //Object classLoader = getClassLoader.invoke(null);
