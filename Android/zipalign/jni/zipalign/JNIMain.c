...
#define DEBUG_TAG "ApkProtector"

jint Java_com_mcal_apkprotector_zipalign_ZipAlign_main(JNIEnv * env, jobject this, jstring args) {
	jboolean isCopy;
  ...
  freopen ("/sdcard/ApkProtect/native_stderr.txt", "w", stderr);
  freopen ("/sdcard/ApkProtect/native_stdout.txt", "w", stdout);
