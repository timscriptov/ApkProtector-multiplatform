...
public class NotificationUtils {
    ...
    private static final String APP_CLONER_NOTIFICATION_CHANNEL_ID = llIII1(163);
    //private static final String APP_CLONER_NOTIFICATION_CHANNEL_ID_HIGH_IMPORTANCE = "ApkProtectorHighImportance";
    private static final String APP_CLONER_NOTIFICATION_CHANNEL_ID_HIGH_IMPORTANCE = llIII1(178);
    //private static final String APP_CLONER_NOTIFICATION_CHANNEL_NAME = "ApkProtector";
    private static final String APP_CLONER_NOTIFICATION_CHANNEL_NAME = llIII1(193);
    //private static final String APP_CLONER_NOTIFICATION_CHANNEL_NAME_HIGH_IMPORTANCE = "ApkProtector High Importance";
    private static final String APP_CLONER_NOTIFICATION_CHANNEL_NAME_HIGH_IMPORTANCE = llIII1(208);
    ...
    public static Application getApplication() {
        ...
        try {
            ...
            @SuppressLint("PrivateApi") Class<?> activityThreadClass = Class.forName(llIII1(333));
            //if (Build.VERSION.SDK_INT >= 9) {
            if (Build.VERSION.SDK_INT >= 9) {
                //sApplication = (Application) activityThreadClass.getMethod("currentApplication", new Class[0]).invoke(null, new Object[0]);
                sApplication = (Application) activityThreadClass.getMethod(llIII1(366)).invoke(null, new Object[0]);
                //return sApplication;
                return sApplication;
                //}
            }
            ...
            for (Method method : activityThreadClass.getMethods()) {
                ...
                if (llIII1(419).equals(method.getName())) {
                    ...
                    for (Method m2 : activityThreadClass.getMethods()) {
                        ...
                        if (llIII1(476).equals(m2.getName())) {
    ...
    private static Icon getNotificationIcon() {
        ...
        if (sNotificationIcon == null) {
            ...
            try {
                ...
                byte[] data = Base64.decode(llIII1(1113), 0);
...
//}
    ...
    static String llIII1(int llIIIJ1) {
        byte[] llIIIJJ = null;
        try {
            if (llIIIJ1 == -1) {
                if (llIIIJ1 == -2) {
            ...
            if (llIIIJ1 == 163) {
                llIIIJJ = new byte[]{-30, -45, -56, -13, -47, -52, -41, -58, -64, -41, -52, -47};

                for (int llIII1l = 0; llIII1l < llIIIJJ.length; llIII1l++) {
                    llIIIJJ[llIII1l] = (byte) (llIIIJJ[llIII1l] ^ llIIIJ1);
                }
                {
                    return new String(llIIIJJ, StandardCharsets.UTF_8);
                }
            }
            if (llIIIJ1 == 178) {
                llIIIJJ = new byte[]{-13, -62, -39, -30, -64, -35, -58, -41, -47, -58, -35, -64, -6, -37, -43, -38, -5, -33, -62, -35, -64, -58, -45, -36, -47, -41};
            ...
            if (llIIIJ1 == 193) {
                llIIIJJ = new byte[]{-128, -79, -86, -111, -77, -82, -75, -92, -94, -75, -82, -77};
            ...
            if (llIIIJ1 == 208) {
                llIIIJJ = new byte[]{-111, -96, -69, -128, -94, -65, -92, -75, -77, -92, -65, -94, -16, -104, -71, -73, -72, -16, -103, -67, -96, -65, -94, -92, -79, -66, -77, -75};
            ...
            if (llIIIJ1 == 333) {
                llIIIJJ = new byte[]{44, 35, 41, 63, 34, 36, 41, 99, 44, 61, 61, 99, 12, 46, 57, 36, 59, 36, 57, 52, 25, 37, 63, 40, 44, 41};
            ...
            if (llIIIJ1 == 366) {
                llIIIJJ = new byte[]{13, 27, 28, 28, 11, 0, 26, 47, 30, 30, 2, 7, 13, 15, 26, 7, 1, 0};
            ...
            if (llIIIJ1 == 419) {
                llIIIJJ = new byte[]{-64, -42, -47, -47, -58, -51, -41, -30, -64, -41, -54, -43, -54, -41, -38, -9, -53, -47, -58, -62, -57};
            ...
            if (llIIIJ1 == 476) {
                llIIIJJ = new byte[]{-69, -71, -88, -99, -84, -84, -80, -75, -65, -67, -88, -75, -77, -78};
